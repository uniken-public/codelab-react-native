...
/**
 * RDNA IDV Additional Document Scan Response Data
 * Response event triggered after initiateIDVAdditionalDocumentScan API call
 * Contains additional document scan details with extracted data for confirmation
 * Following current project's RDNAEvent structure for consistency
 */
export interface RDNAIDVAdditionalDocumentScanData extends RDNAEvent {
  challengeMode?: number;
  idvResponse?: {
    version?: string;
...
// IDV KYC Callbacks
export type RDNAIDVAdditionalDocumentScanCallback = (data: RDNAIDVAdditionalDocumentScanData) => void;

// --- Custom Challenge Events ---

/**
 * RDNA Custom Challenge Info Structure
 * Key-value pairs for custom challenge configuration
 */
export interface RDNACustomChallengeInfo {
  key: string;
  value: string;
}

/**
 * RDNA Custom Challenge Response Structure
 * Response structure for custom challenge
 */
export interface RDNACustomChallengeResponse {
  response: string;
}


// Custom Challenge Callbacks
export type RDNAHandleCustomChallengeCallback = (data: RDNAHandleCustomChallengeData) => void;
