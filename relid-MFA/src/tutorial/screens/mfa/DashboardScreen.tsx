...
const DashboardScreen: React.FC = () => {
  ...
  const handleLogOut = async () => {
    Alert.alert(
      'Log Off',
      'Are you sure you want to log off from the application?',
      [
        {
          text: 'Cancel',
          style: 'cancel',
  ...
  const performLogOut = async () => {
    ...
    try {
      console.log('DashboardScreen - Initiating logOff for user:', userID);
      
      await rdnaService.logOff(userID);
      console.log('DashboardScreen - LogOff API call successful');
