...
export const SDKEventProvider: React.FC<SDKEventProviderProps> = ({ children }) => {
  ...
  const handleGetIDVSelfieProcessStartConfirmation = useCallback((data: RDNAGetIDVSelfieProcessStartConfirmationData) => {
    ...
    // Following the same pattern as document scan confirmation navigation
  ...
  /**
   * Event handler for IDV document confirmation requests
   */
  const handleGetIDVConfirmDocumentDetails = useCallback((data: RDNAGetIDVConfirmDocumentDetailsData) => {
    ...
    // Following the same pattern as other SDK event handlers
  ...
  /**
   * Event handler for IDV selfie confirmation requests
   */
  const handleGetIDVSelfieConfirmation = useCallback((data: RDNAGetIDVSelfieConfirmationData) => {
    ...
    // Following the same pattern as reference BiometricConfirmationScreen navigation
