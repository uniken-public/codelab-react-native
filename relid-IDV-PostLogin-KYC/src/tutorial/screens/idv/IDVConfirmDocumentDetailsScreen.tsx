...
import type { RDNAGetIDVConfirmDocumentDetailsData } from '../../../uniken/types/rdnaEvents';
...
const IDVConfirmDocumentDetailsScreen: React.FC<Props> = ({ route, navigation }) => {
  ...
  const responseJson = isAdditionalDocScan ? 
    documentDetails.idvResponse : 
    documentDetails.response_data;
  ...
  const handleConfirm = async (isConfirm: boolean) => {
    try {
      ...
      await RdnaService.setIDVConfirmDocumentDetails(isConfirm, documentDetails.challengeMode);
      ...
      <View style={styles.buttonContainer}>
        ...
        >
          <Text style={styles.rejectButtonText}>
            {isAdditionalDocScan ? 'Recapture' : 'Recapture'}
          </Text>
        </TouchableOpacity>
