 ...
 * - Forgot password functionality (when challengeMode == 0 and ENABLE_FORGOT_PASSWORD is true)
...
const VerifyPasswordScreen: React.FC = () => {
  ...
  const handleVerifyPassword = async () => {
    ...
    try {
      ...
      // Note: Forgot password is available when challengeMode === 0 and ENABLE_FORGOT_PASSWORD is true
      if (isForgotPasswordEnabled()) {
        console.log('VerifyPasswordScreen - Manual password entry mode, forgot password available');
      }
      ...
      if (challengeMode !== 0) {
        console.log('VerifyPasswordScreen - ChallengeMode is not 0, closing screen after successful password submission');
        navigation.goBack();
      }
