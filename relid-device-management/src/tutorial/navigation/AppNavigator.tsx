...
import { CheckUserScreen, ActivationCodeScreen, UserLDAConsentScreen, SetPasswordScreen, VerifyPasswordScreen, UpdateExpiryPasswordScreen, VerifyAuthScreen } from '../../tutorial/screens/mfa';
import DrawerNavigator from './DrawerNavigator';

// Import Data Signing screens
import { DataSigningInputScreen, DataSigningResultScreen } from '../screens/dataSigning';

// Import Device Management screens
import { DeviceDetailScreen } from '../screens/deviceManagement';

// Import RDNA types
import type { RDNAGetUserConsentForLDAData, RDNAGetPasswordData, RDNAAddNewDeviceOptionsData, RDNARegisteredDevice } from '../../uniken/types/rdnaEvents';
...
export type RootStackParamList = {
  ...
  // Data Signing Screens
  DataSigningInput: undefined;
  DataSigningResult: undefined;
  ...
  return (
    <NavigationContainer ref={navigationRef}>
      <Stack.Navigator screenOptions={{headerShown: false}} initialRouteName="TutorialHome">
        ...
        <Stack.Screen
          name="DataSigningResult"
          component={DataSigningResultScreen}
          options={{
