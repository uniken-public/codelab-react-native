...
import { useSDKEvent } from '../../../uniken/providers/SDKEventProvider';
...
const DrawerContent: React.FC<DrawerContentProps> = ({ userParams, ...props }) => {
  ...
  console.log('DrawerContent - Available credentials:', availableCredentials);

  const userID = userParams?.userID || 'Unknown User';

  // Check if Password update is available
    ...
    <View style={styles.container}>
      <DrawerContentScrollView {...props}>
        ...
        <View style={styles.menu}>
          ...
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => props.navigation.navigate('NotificationHistory')}
          >
          ...
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => props.navigation.navigate('LDAToggling')}
          >
            <Text style={styles.menuText}>🔐 LDA Toggling</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => props.navigation.navigate('DataSigning')}
          >
            <Text style={styles.menuText}>✍️ Data Signing</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => props.navigation.navigate('DeviceManagement')}
          >
