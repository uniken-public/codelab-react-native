...
export type RDNAGetNotificationHistoryCallback = (data: RDNAGetNotificationHistoryData) => void;
...
// ================================================================================================
// DATA SIGNING EVENT TYPES
// ================================================================================================

/**
 * Data Signing Response Structure
 * Response from onAuthenticateUserAndSignData event containing the signed payload
 */
export interface RDNADataSigningResponse {
  dataPayload: string;
...
export type RDNADataSigningResponseCallback = (data: RDNADataSigningResponse) => void;
...
/**
 * RDNA Registered Device
 * Individual device information in the registered devices list
 */
export interface RDNARegisteredDevice {
  ...
  lastAccessedTsEpoch: number;
  createdTs: string;
  createdTsEpoch: number;
  appUuid: string;
...
/**
 * RDNA Registered Device Response Data
 * Response structure containing device list and cooling period information
 */
export interface RDNARegisteredDeviceResponseData {
  device: RDNARegisteredDevice[];
  deviceManagementCoolingPeriodEndTimestamp: number;
}

/**
 * RDNA Get Registered Device Details Data
 * Complete response structure for onGetRegistredDeviceDetails event
 */
export interface RDNAGetRegisteredDeviceDetailsData {
  ...
  pArgs: {
    service_details: any;
    response: {
      ResponseData: RDNARegisteredDeviceResponseData;
      ResponseDataLen: number;
      StatusMsg: string;
      StatusCode: number;
      CredOpMode: number;
...
/**
 * RDNA Update Device Details Response Data
 * Response structure for device rename/delete operations
 */
export interface RDNAUpdateDeviceDetailsResponseData {
  status_code: number;
  message: string;
  dev_uuid: string;
}
...
/**
 * RDNA Update Device Details Data
 * Complete response structure for onUpdateDeviceDetails event
 */
export interface RDNAUpdateDeviceDetailsData {
  ...
  pArgs: {
    service_details: any;
    response: {
      ResponseData: RDNAUpdateDeviceDetailsResponseData;
      ResponseDataLen: number;
      StatusMsg: string;
      StatusCode: number;
      CredOpMode: number;
